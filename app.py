...
MEAT_PROCESSING_CHECKLIST_ITEMS = [
    ...
    {"id": "25", "desc": "Absence of condensation, mold, etc. and properly maintained and operated", "wt": 2, "category": "CHILL ROOM", "critical": True},
    {"id": "26", "desc": "Carcass stored to facilitate air flow", "wt": 2, "category": "CHILL ROOM", "critical": False},
